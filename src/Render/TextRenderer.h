...
public:
	...
	void renderText(Shader* shader, std::string text, GLfloat x, GLfloat y, GLfloat scaleX, GLfloat scaleY, bool center, glm::vec3 color);
	void renderText(Shader* shader, std::string text, GLfloat x, GLfloat y, glm::vec2 scale, bool center, glm::vec3 color);
	void renderText(Shader* shader, std::string text, GLfloat x, GLfloat y, GLfloat scale = 1.0f, bool center = true, glm::vec3 color = glm::vec3(1.0f));
