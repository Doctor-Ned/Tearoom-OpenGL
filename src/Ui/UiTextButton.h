...
public:
	UiTextButton(const char* textureIdle, const char* textureHover, const char* textureClicked,
		glm::vec2 position, glm::vec2 size, const char* text, float textHeightScale = BASE_TEXT_HEIGHT_SCALE, glm::vec3 textColor = glm::vec3(0.3f, 0.3f, 0.3f), bool center = true,
