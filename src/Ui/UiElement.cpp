...
UiElement::UiElement(glm::vec2 position, glm::vec2 size, UiAnchor anchor) : size(size), rotationAnchor(anchor), localTransform(InterfaceTransform(dirty, size, anchor)), worldTransform(Transform(dirty)) {
