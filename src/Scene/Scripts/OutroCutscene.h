...
protected:
	...
	//outro sprites
    UiPlane* text1 =  new UiPlane("res/textures/Outro/outroLine1.PNG", glm::vec2(404.0f, 90.0f), glm::vec2(512.0f, 100.0f), TopLeft);
    UiPlane* text2 =  new UiPlane("res/textures/Outro/outroLine2.PNG", glm::vec2(408.0f, 180.0f), glm::vec2(520.0f, 120.0f), TopLeft);
    UiPlane* text3 =  new UiPlane("res/textures/Outro/outroLine3.PNG", glm::vec2(400.0f, 290.0f), glm::vec2(523.0f, 100.0f), TopLeft);
    UiPlane* text4 =  new UiPlane("res/textures/Outro/outroLine4.PNG", glm::vec2(405.0f, 388.0f), glm::vec2(500.0f, 120.0f), TopLeft);
    ...
    UiColorPlane* playAgainHover = new UiColorPlane(glm::vec4(0.0f, 0.0f, 0.0f, 0.8f), glm::vec2(490.0f, 375.0f), glm::vec2(100.0f,52.0f), Left);
	UiColorPlane* quitHover = new UiColorPlane(glm::vec4(0.0f, 0.0f, 0.0f, 0.8f), glm::vec2(681.0f, 373.0f), glm::vec2(100.0f, 50.0f), Left);
