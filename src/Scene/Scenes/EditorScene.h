...
//protected:
	...
	SerializableType creatableComponents[17] = { SKeyFrameAnimation, SSkeletalAnimation, SAnimationController, SBillboard, SBoxCollider, SSphereCollider, SPhysicalObject, SRotatingObject, SCollectableObject, SPicking, SPlayerMovement,
		SDirLightComp, SSpotLightComp, SPointLightComp, SSun, SSunController, SAnimTimeSaver};
