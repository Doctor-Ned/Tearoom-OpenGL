...
LoadingScene::LoadingScene() {
	...
	UiColorPlane *loadingBar1 = new UiColorPlane(glm::vec4(0.4f, 0.4f, 0.4f, 1.0f), glm::vec2(UI_REF_CEN_X - loadingBarWidth / 2.0f, UI_REF_HEIGHT * 0.75f), glm::vec2(loadingBarWidth, UI_REF_HEIGHT*0.15f), Left);
	loadingBar = new UiColorPlane(glm::vec4(0.0f, 0.6f, 0.0f, 1.0f), glm::vec2(UI_REF_CEN_X - loadingBarWidth / 2.0f, UI_REF_HEIGHT * 0.75f), glm::vec2(loadingBarWidth, UI_REF_HEIGHT*0.15f), Left);
