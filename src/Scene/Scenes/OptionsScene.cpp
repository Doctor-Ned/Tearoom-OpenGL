...
OptionsScene::OptionsScene(MenuScene* menuScene) {
	...
	uiElements.emplace_back(enableLights);
	uiElements.emplace_back(enableShadowCasting);
	...
	uiElements.emplace_back(new UiText(glm::vec2(windowCenterX, 2 * heightSeg), glm::vec2(2.0f*checkboxShift, BASE_BTN_SIZE*windowWidth), "Enable lights"));
	uiElements.emplace_back(new UiText(glm::vec2(windowCenterX, 3 * heightSeg), glm::vec2(2.0f*checkboxShift, BASE_BTN_SIZE*windowWidth), "Enable shadow casting"));
