...
void APIENTRY glDebugOutput(GLenum source,
	...
	switch (source) {
		case GL_DEBUG_SOURCE_API:             msg.append("Source: API\n"); break;
		case GL_DEBUG_SOURCE_WINDOW_SYSTEM:   msg.append("Source: Window System\n"); break;
		case GL_DEBUG_SOURCE_SHADER_COMPILER: msg.append("Source: Shader Compiler\n"); break;
		case GL_DEBUG_SOURCE_THIRD_PARTY:     msg.append("Source: Third Party\n"); break;
		case GL_DEBUG_SOURCE_APPLICATION:     msg.append("Source: Application\n"); break;
		case GL_DEBUG_SOURCE_OTHER:           msg.append("Source: Other\n"); break;
	}

	switch (type) {
		case GL_DEBUG_TYPE_ERROR:               msg.append("Type: Error\n"); break;
		case GL_DEBUG_TYPE_DEPRECATED_BEHAVIOR: msg.append("Type: Deprecated Behaviour\n"); break;
		case GL_DEBUG_TYPE_UNDEFINED_BEHAVIOR:  msg.append("Type: Undefined Behaviour\n"); break;
		case GL_DEBUG_TYPE_PORTABILITY:         msg.append("Type: Portability\n"); break;
		case GL_DEBUG_TYPE_PERFORMANCE:         msg.append("Type: Performance\n"); break;
		case GL_DEBUG_TYPE_MARKER:              msg.append("Type: Marker\n"); break;
		case GL_DEBUG_TYPE_PUSH_GROUP:          msg.append("Type: Push Group\n"); break;
		case GL_DEBUG_TYPE_POP_GROUP:           msg.append("Type: Pop Group\n"); break;
		case GL_DEBUG_TYPE_OTHER:               msg.append("Type: Other\n"); break;
	}

	switch (severity) {
		case GL_DEBUG_SEVERITY_HIGH:         msg.append("Severity: high\n"); break;
		case GL_DEBUG_SEVERITY_MEDIUM:       msg.append("Severity: medium\n"); break;
		case GL_DEBUG_SEVERITY_LOW:          msg.append("Severity: low\n"); break;
		case GL_DEBUG_SEVERITY_NOTIFICATION: msg.append("Severity: notification\n"); break;
	}

	SPDLOG_WARN(msg.c_str(), id, message);
}
